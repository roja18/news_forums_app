...
class SoatecoFormPost extends StatefulWidget {
  const SoatecoFormPost({super.key});

  @override
  State<SoatecoFormPost> createState() => _SoatecoFormPostState();
}

class _SoatecoFormPostState extends State<SoatecoFormPost> {
